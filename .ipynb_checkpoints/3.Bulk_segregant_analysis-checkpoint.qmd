...
execute:
  ...
  message: FALSE
---
# Read the data. Pay attention to the correspondence between mutant and wildtype samples, which are located in column 4 (mutant) and column 3 (wt), respectively.
